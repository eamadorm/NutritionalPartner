...
This skill handles the technical design and project management orchestration for the Nutritional Partner project.
...
- **Folder Structure**: Use the split structure:
    - `backend/<name>/source_code/`
    - `backend/<name>/deployment/`
    - `frontend/<name>/source_code/`
    - `frontend/<name>/deployment/`
- **Shared Infrastructure**: Use `infra/shared_resources/` for cross-cutting GCP resources.
