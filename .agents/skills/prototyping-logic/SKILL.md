...
- **Mandatory**: Use `import sys; sys.path.append("<relative_path_to_root>")` to correctly import modules from the project root (e.g., `sys.path.append("../..")` if the notebook is two levels deep).
